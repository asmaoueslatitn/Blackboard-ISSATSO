namespace BlackBoard.Migrations
{
    ...
    public partial class InitialDb : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ExamRemarks = c.String(nullable: false),
                        Interpretation = c.String(nullable: false, maxLength: 255),
                        SecondInterpretation = c.String(),
                        ThirdInterpretation = c.String(),
                        RecoverCandidate = c.String(nullable: false),
                ...
                c => new
                    {
                        ...
                        DivisionD = c.Int(nullable: false),
                        LevelG = c.Int(nullable: false),
                        SemesterDate = c.DateTime(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Teachers", "PhysicianId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Teachers", new[] { "PhysicianId" });
